"""
Django settings for intelliplan project.
...
ALLOWED_HOSTS = ['intelliplan1.onrender.com', 'localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'intelliplan.wsgi.application'
